...
class Svelte
{
    ...
    {
        wp_enqueue_script( 'swp', plugins_url( 'public/build/bundle.js', dirname( __FILE__ ) ), array(), time(), true );
        wp_enqueue_style( 'swp', plugins_url( 'public/build/bundle.css', dirname( __FILE__ ) ), array(), time() );
